...
public final class Endpoints {
    ...
    public static final CamelEndpoint EGG_ORDER_JMS_ENDPOINT = new CamelEndpoint("jms:queue:eggs?disableReplyTo=true&username=quarkus&password=quarkus&connectionFactory=#JMSConnectionFactory", "jms_queue_eggs");
